...
$(document).ready(function(){	
	...
	//ui changes on login
	function loginui() {
        $("[id^=nav-main]").find('a[href*="signin.php"]').css("display", "none");
        $("[id^=nav-main]").find('a[href*="app"]').css("display", "inline-block");
	}
	
	//ui changes on logout
	function logoutui() {
        $("[id^=nav-main]").find('a[href*="signin.php"]').css("display", "inline-block");
        $("[id^=nav-main]").find('a[href*="app"]').css("display", "none");
	}
